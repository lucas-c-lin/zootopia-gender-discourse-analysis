...
The project follows a modular pipeline, from raw data acquisition to advanced statistical modeling (LMM).

::: {.grid}

::: {.g-col-12}
### Phase 1: Data Preparation
1. **Web Scraping**: Extracting movie transcripts from the [Zootopia Fandom Wiki](https://zootopia.fandom.com/wiki/Zootopia/Transcript).
2. **Corpus Standardization**: Data cleaning and structured corpus construction.
3. **Metadata Integration**: Joining character attributes (gender, species) from `Character_info.csv`.
...
Investigating vocabulary density across gender groups.

- **Metric**: Type-Token Ratio (TTR) per utterance.

- **Comparison**: Mean TTR difference testing.

- **Modeling**: **Linear Mixed-Effects (LMM)** to control for character-level variation.
...
## [B] Sentiment Dynamics

Comparing dictionary-based vs. context-aware algorithms.

- **Path 1 (AFINN)**:

  - Sentiment scoring ➔ Mean comparison ➔ **LMM Modeling**.
...
A diachronic deep-dive into the film's protagonists.

- **Target**: Judy Hopps vs. Nick Wilde.

- **Goal**: Evaluating individual development vs. collective gender patterns.
...
```{r}
#| label: simplify-dietary-alignment
#| warning: false
#| echo: true
...
```{r}
#| label: gender-dietary-count-simplified
#| warning: false
#| echo: true
...
```{r}
#| label: gender-alignment-count-simplified
#| warning: false
#| echo: true
...
```{r}
#| label: gender-vocabulary-comparison
#| warning: false
#| echo: true
...
```{r}
#| label: ttr-t-test-visualization
#| warning: false
#| echo: true
...
```{r}
#| label: mixed-model-ttr-intercept
#| warning: false
#| echo: true
...
```{r}
#| label: sentiment-t-test-visualization
#| warning: false
#| echo: true
...
```{r}
#| label: saying-sentiment-word-calc
#| warning: false
#| echo: true
...
```{r}
#| label: saying-sentiment-word-plot
#| warning: false
#| echo: true
...
```{r}
#| label: mixed-model-word-level-single
#| warning: false
#| echo: true
...
```{r}
#| label: mixed-model-word-level-intercept
#| warning: false
#| echo: true
...
```{r}
#| label: sentence-sentiment-gender-stats
#| warning: false
#| echo: true
...
```{r}
#| label: sentence-sentiment-gender-plot
#| warning: false
#| echo: true
...
```{r}
#| label: mixed-model-sentence-single
#| warning: false
#| echo: true
...
```{r}
#| label: mixed-model-sentence-intercept-anova
#| warning: false
#| echo: true
